...
try {
    ...
    $type = $testController->getTypeOfTest($id);
} catch (Throwable $th) {
    // Mensaje de error
...
<body background="../img/backgrounds/info-min.png">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <a href="/admin/vistas/gestion-examen.php?test=<?php echo $id; ?>" id="btn-back" class="btn btn-primary btn-sm">
                ...
                <div class="modal-body principal">
                    <div style="padding: 0 50px;">
                        <div class="form-group principal">
                            <label for="">Edite la nueva pregunta</label>
                            <input type="hidden" id="id-test" name="id-test" value="<?php echo $id; ?>">
                            <input type="text" class="form-input d-block w-100" id="txt-add-question">
                            <small class="form-text text-muted">Cuando tenga lista la pregunta, de click en Agregar</small>
                        </div>
                        <div class="modal-footer border-0 d-flex justify-content-center">
                            <a href="/admin/vistas/gestion-examen.php?test=<?php echo $id; ?>" type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Cancelar</a>
                            <button id="btn-add-question" class="btn btn-primary btn-sm">Agregar</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Scripts -->
    <script type="text/javascript" src="../js/pregunta-examen.js"></script>
</body>
